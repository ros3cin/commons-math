...
public final class AklToussaintHeuristic {
    ...
    public static Collection<Vector2D> reducePoints(final Collection<Vector2D> points) {
        ...
        final List<Vector2D> reducedPoints = new org.apache.commons.collections4.list.TreeList<Vector2D>(quadrilateral);
    ...
    private static List<Vector2D> buildQuadrilateral(final Vector2D... points) {
        List<Vector2D> quadrilateral = new org.apache.commons.collections4.list.TreeList<Vector2D>();
        for (Vector2D p : points) {
