...
public class PolygonsSet extends AbstractRegion<Euclidean2D, Euclidean1D> {
    ...
    private static void insertEdges(final double hyperplaneThickness, final BSPTree<Euclidean2D> node, final List<Edge> edges) {
        ...
        final List<Edge> plusList = new org.apache.commons.collections4.list.TreeList<Edge>();
        final List<Edge> minusList = new org.apache.commons.collections4.list.TreeList<Edge>();
    ...
    public Vector2D[][] getVertices() {
        if (vertices == null) {
            if (getTree(false).getCut() == null) {
                ...
                final java.util.List<List<Segment>> loops = new org.apache.commons.collections4.list.TreeList<List<Segment>>();
    ...
    private static class SegmentsBuilder implements BSPTreeVisitor<Euclidean2D> {
        ...
        public SegmentsBuilder(final double tolerance) {
            ...
            this.segments = new org.apache.commons.collections4.list.TreeList<ConnectableSegment>();
        }
