...
class NestedLoops {
    ...
    public NestedLoops(final double tolerance) {
        this.surrounded = new org.apache.commons.collections4.list.TreeList<NestedLoops>();
    ...
    private NestedLoops(final Vector2D[] loop, final double tolerance) throws MathIllegalArgumentException {
        ...
        final java.util.List<SubHyperplane<Euclidean2D>> edges = new org.apache.commons.collections4.list.TreeList<SubHyperplane<Euclidean2D>>();
