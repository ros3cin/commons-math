...
public class MonotoneChain extends AbstractConvexHullGenerator2D {
    ...
    public Collection<Vector2D> findHullVertices(final Collection<Vector2D> points) {
        final List<Vector2D> pointsSortedByXAxis = new org.eclipse.collections.impl.list.mutable.FastList<Vector2D>(points);
        ...
        // build lower hull
        final List<Vector2D> lowerHull = new org.eclipse.collections.impl.list.mutable.FastList<Vector2D>();
        for (Vector2D p : pointsSortedByXAxis) {
            updateHull(p, lowerHull);
        }
        // build upper hull
        final List<Vector2D> upperHull = new org.eclipse.collections.impl.list.mutable.FastList<Vector2D>();
        ...
        final List<Vector2D> hullVertices = new org.eclipse.collections.impl.list.mutable.FastList<Vector2D>(lowerHull.size() + upperHull.size() - 2);
