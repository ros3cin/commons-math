...
public class ExpandableStatefulODE {
    ...
    public ExpandableStatefulODE(final FirstOrderDifferentialEquations primary) {
        ...
        this.components = new org.eclipse.collections.impl.list.mutable.FastList<ExpandableStatefulODE.SecondaryComponent>();
    }
    ...
    public int addSecondaryEquations(final SecondaryEquations secondary) {
        ...
        if (components.isEmpty()) {
            ...
            components = new org.eclipse.collections.impl.list.mutable.FastList<ExpandableStatefulODE.SecondaryComponent>();
