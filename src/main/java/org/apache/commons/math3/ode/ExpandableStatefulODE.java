...
public class ExpandableStatefulODE {
    ...
    public ExpandableStatefulODE(final FirstOrderDifferentialEquations primary) {
        ...
        this.components = new org.apache.commons.collections4.list.TreeList<ExpandableStatefulODE.SecondaryComponent>();
    }
    ...
    public int addSecondaryEquations(final SecondaryEquations secondary) {
        ...
        if (components.isEmpty()) {
            ...
            components = new org.apache.commons.collections4.list.TreeList<ExpandableStatefulODE.SecondaryComponent>();
