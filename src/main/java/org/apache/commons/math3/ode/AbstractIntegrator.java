...
public abstract class AbstractIntegrator implements FirstOrderIntegrator {
    ...
    public AbstractIntegrator(final String name) {
        this.name = name;
        stepHandlers = new org.eclipse.collections.impl.list.mutable.FastList<StepHandler>();
        stepStart = Double.NaN;
        stepSize = Double.NaN;
        eventsStates = new org.eclipse.collections.impl.list.mutable.FastList<EventState>();
    ...
    public Collection<EventHandler> getEventHandlers() {
        final List<EventHandler> list = new org.eclipse.collections.impl.list.mutable.FastList<EventHandler>(eventsStates.size());
