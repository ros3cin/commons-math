...
public class CycleCrossover<T> implements CrossoverPolicy {
    ...
    protected ChromosomePair mate(final AbstractListChromosome<T> first, final AbstractListChromosome<T> second) throws DimensionMismatchException {
        ...
        final List<T> child1Rep = new org.eclipse.collections.impl.list.mutable.FastList<T>(second.getRepresentation());
        final List<T> child2Rep = new org.eclipse.collections.impl.list.mutable.FastList<T>(first.getRepresentation());
