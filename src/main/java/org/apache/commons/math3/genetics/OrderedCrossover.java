...
public class OrderedCrossover<T> implements CrossoverPolicy {
    ...
    protected ChromosomePair mate(final AbstractListChromosome<T> first, final AbstractListChromosome<T> second) throws DimensionMismatchException {
        ...
        // and of the children
        final List<T> child1 = new org.eclipse.collections.impl.list.mutable.FastList<T>(length);
        final List<T> child2 = new org.eclipse.collections.impl.list.mutable.FastList<T>(length);
        // sets of already inserted items for quick access
        final Set<T> child1Set = new org.eclipse.collections.impl.set.mutable.UnifiedSet<T>(length);
        final Set<T> child2Set = new org.eclipse.collections.impl.set.mutable.UnifiedSet<T>(length);
