...
public class KMeansPlusPlusClusterer<T extends Clusterable> extends Clusterer<T> {
    ...
    public List<CentroidCluster<T>> cluster(final Collection<T> points) throws MathIllegalArgumentException, ConvergenceException {
        ...
        for (int count = 0; count < max; count++) {
            ...
            List<CentroidCluster<T>> newClusters = new org.apache.commons.collections4.list.TreeList<CentroidCluster<T>>();
    ...
    private List<CentroidCluster<T>> chooseInitialCenters(final Collection<T> points) {
        ...
        final List<CentroidCluster<T>> resultSet = new org.apache.commons.collections4.list.TreeList<CentroidCluster<T>>();
