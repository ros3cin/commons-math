...
public class CMAESOptimizer extends BaseAbstractMultivariateSimpleBoundsOptimizer<MultivariateFunction> implements MultivariateOptimizer {
     ...
     */
    private List<Double> statisticsSigmaHistory = new org.eclipse.collections.impl.list.mutable.FastList<Double>();

    /**
     * History of mean matrix.
     */
    private List<RealMatrix> statisticsMeanHistory = new org.eclipse.collections.impl.list.mutable.FastList<RealMatrix>();

    /**
     * History of fitness values.
     */
    private List<Double> statisticsFitnessHistory = new org.eclipse.collections.impl.list.mutable.FastList<Double>();

    /**
     * History of D matrix.
     */
    private List<RealMatrix> statisticsDHistory = new org.eclipse.collections.impl.list.mutable.FastList<RealMatrix>();
