...
public class HermiteInterpolator implements UnivariateDifferentiableVectorFunction {
    ...
    public HermiteInterpolator() {
        this.abscissae = new org.eclipse.collections.impl.list.mutable.FastList<Double>();
        this.topDiagonal = new org.apache.commons.collections4.list.TreeList<double[]>();
        this.bottomDiagonal = new org.eclipse.collections.impl.list.mutable.FastList<double[]>();
    }
