...
public class HermiteInterpolator implements UnivariateDifferentiableVectorFunction {
    ...
    public HermiteInterpolator() {
        ...
        this.topDiagonal = new org.eclipse.collections.impl.list.mutable.FastList<double[]>();
        this.bottomDiagonal = new org.apache.commons.collections4.list.TreeList<double[]>();
    }
