...
public class CMAESOptimizer extends MultivariateOptimizer {
     ...
     */
    private final List<Double> statisticsSigmaHistory = new org.eclipse.collections.impl.list.mutable.FastList<Double>();

    /**
     * History of mean matrix.
     */
    private final List<RealMatrix> statisticsMeanHistory = new org.eclipse.collections.impl.list.mutable.FastList<RealMatrix>();

    /**
     * History of fitness values.
     */
    private final List<Double> statisticsFitnessHistory = new org.eclipse.collections.impl.list.mutable.FastList<Double>();

    /**
     * History of D matrix.
     */
    private final List<RealMatrix> statisticsDHistory = new org.eclipse.collections.impl.list.mutable.FastList<RealMatrix>();
